...
export const metadata: Metadata = {
  title: "Advaith Arya G",
  description:
    "Advaith Arya G's portfolio, featuring projects and experience in software development.",
  metadataBase: new URL("https://advaith.is-a.dev"),
  openGraph: {
    title: "Advaith Arya G",
    description:
      "Advaith Arya G's portfolio, featuring projects and experience in software development.",
    url: "https://advaith.is-a.dev",
    siteName: "Advaith Arya G",
    images: ["/images/advaith-profile.jpg"],
  },
};
